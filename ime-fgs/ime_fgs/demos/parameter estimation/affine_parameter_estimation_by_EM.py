...
if __name__ == '__main__':
    ...
    embase = EMMatrixFilter(A_0, A_theta, theta, B, C, initial_state, matrix_parameterization='affine',
                            input_noise_cov=0, process_noise_cov=process_noise_cov, meas_noise_cov=0)

    for ii in range(num_meas):
        embase.add_slice(np.atleast_2d(input1[ii]), [[measurements1[ii + 1]], [measurements2[ii + 1]]])
